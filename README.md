...
This is a sample template for Azarashi-2 - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name azarashi-2 --tail
```
...
```bash
aws cloudformation delete-stack --stack-name azarashi-2
```
